    ...
    return(
      <section className="create-graph">
        <form>
          ...
          <label>Graph Suffix:</label><input ref={(value)=> this.graphSuffix = value} type="text" placeholder="$"></input>
          <label>Graph Prefix:</label><input ref={(value)=> this.graphPrefix = value} type="text" placeholder="k"></input>
